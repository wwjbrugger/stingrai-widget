...
folder_to_analyze=(
      '0.0-0.1->0.3-0.4.pkl'  '0.0-0.1->0.7-0.8.pkl'  '0.2-0.3->0.3-0.4.pkl'  '0.2-0.3->0.7-0.8.pkl'  '0.4-0.5->0.5-0.6.pkl'  '0.4-0.5->0.9-1.0.pkl'  '0.6-0.7->0.9-1.0.pkl'
  '0.0-0.1->0.5-0.6.pkl'  '0.0-0.1->0.9-1.0.pkl'  '0.2-0.3->0.5-0.6.pkl'  '0.2-0.3->0.9-1.0.pkl'  '0.4-0.5->0.7-0.8.pkl'  '0.6-0.7->0.7-0.8.pkl'  '0.8-0.9->0.9-1.0.pkl'

 )
for folder in "${folder_to_analyze[@]}";do
  echo  $folder is analyzed
  python start_integrated_gradient.py --interval_name $folder --folder_name_index unsegmented
done
